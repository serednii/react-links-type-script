...
const ChangeLinks: React.FC = () => {
    ...
    const handleCloseModal = () => {
        ...
        setTimeout(() => valueContext.setIsChangeLinks(false), 1000)
    }
                    ...
                    <div className='action'>
                        ...
                        {selectAction === 'add-link' && (
                            ...
                            <div className='action-type'>
                                ...
                                <button className='add-other__btn' onClick={addLink}>Add New Link</button>
                            </div>
                        )}
                        ...
                        {selectAction === 'change' &&
                            (
                                <div className='action-type'>
                                    ...
                                    <button disabled={selectActionLink === ''} className='add-other__btn' onClick={changeLink}>Add New Link</button>
                                </div>
                            )}

                        {selectAction === 'delete' && (
                            <div className='action-type'>
                                <p>Are you sure you want to delete the menu item {selectActionLink !== '' && dataMenu[key] && dataMenu[key].length > 0 && dataMenu[key][+selectActionLink].name}</p>
                                <button disabled={selectActionLink === ''} className='add-other__btn' onClick={deleteLink}>Delete menu</button>
                            </div>
                        )}
